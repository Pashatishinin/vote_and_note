...
def test_return_user(test_user):
    ...
    assert response.json()['username'] == 'patish'
    assert response.json()['email'] == "support@gmail.com"
    assert response.json()['first_name'] == "Pavlo"
    assert response.json()['last_name'] == "Tishynin"
